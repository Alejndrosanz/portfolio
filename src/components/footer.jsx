...
import { faLinkedin, faBehance, faInstagram, faGithub } from '@fortawesome/free-brands-svg-icons';
	...
	return (
      ...
      <div className="socials">
			...
			<button className="btn btn-l">
				<a href="https://www.instagram.com/alejndrosanz/" target="_blank" rel="noreferrer">
					<span className="IconI">{Instagram}</span>
					<span className="UserI">/ alejndrosanz</span>
				</a>
			</button>
			<button className="btn btn-d">
				<a href="https://www.behance.net/alejandsanzro" target="_blank" rel="noreferrer">
					<span className="IconB">{Behance}</span>
					<span className="UserB">/ alejndrosanz</span>
				</a>
			</button>
			<button className="btn btn-b">
				<a href="https://github.com/Alejndrosanz" target="_blank" rel="noreferrer">
					<span className="IconD">{Github}</span>
					<span className="UserD">/ alejndrosanz</span>
				</a>
			</button>
			<button className="btn btn-i">
				<a href="https://www.linkedin.com/in/alejandro-sanz-rodriguez-653328174/" target="_blank" rel="noreferrer">
